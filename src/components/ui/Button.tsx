...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'secondary', size = 'default', loading = false, disabled, icon, children, ...props }, ref) => {
    ...
    const variantStyles = {
      ...
      secondary: 'glass-subtle text-text-primary hover:bg-surface-elevated hover:border-border-strong text-text-primary border border-border',
